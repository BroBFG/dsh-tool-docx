...
import { writeFileAtomicBytes } from "./fsio-bytes.js";
/**
 ...
 */
export async function performByteWrite(provider, target, data, expected, signal) {
    ...
    await writeFileAtomicBytes(String(target.targetKey), data, signal, expected?.kind === 'createIfAbsent' ? { displayPath: target.displayPath } : undefined);
...
//# sourceMappingURL=fs-binary-local.js.map